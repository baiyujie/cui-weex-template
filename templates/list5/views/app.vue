<template>
    <div class="flex-column">
        <cui-header title="列表-组合类列表" :leftItem="leftItem" @leftClick="back"></cui-header>
        ...
        <slider class="flex-row span1" @change="onSliderChange" :index="currentTab">
            ...
            <div class="form-box">
                <scroller class="form-body width750">
                    ...
                    <cui-cell class="mt25" :cellStyle="largestwhite" v-for='(value, index) in datas2' :key="index">
                        <div slot="title" class="flex-column">
            ...
            <div class="form-box">
                <scroller class="form-body width750">
                    <div class="flex-column pd25 mt25 bgwh" v-for='(value, index) in datas' :key="index">
                        ...
                        <div class="center mt15" @click="value.open = !value.open"><cui-icon @click="value.open = !value.open" :style="{'transform': value.open ? 'rotate(0deg)' : 'rotate(180deg)'}" color="#cdcdcd"  name="ion-ios-arrow-up"></cui-icon></div>
                    </div>
                </scroller>
            </div>
            ...
            <div class="form-box">
                <scroller class="form-body width750">
                    <cui-cell class="mt25" :cellStyle="largerwhite" v-for='(value, index) in datas1' :key="index">
                        <div slot="title" class="flex-column">
