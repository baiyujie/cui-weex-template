<template>
    <div class="flex-column">
        <cui-header title="消息-消息类-列表操作-左滑动菜单" :leftItem="leftItem" @leftClick="back"></cui-header>

        <div class="form-box">
            <scroller class="form-body">
                <cui-swipe-cell v-for='(value, index) in datas' :key="index" :items="btnAry" :height="'150px'">
