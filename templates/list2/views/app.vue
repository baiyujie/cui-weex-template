<template>
    <div class="flex-column">
        <cui-header title="列表-排行" :leftItem="leftItem" @leftClick="back"></cui-header>
        ...
        <slider class="form-box">
            <div class="form-box">
                <scroller class="form-body width750">
                    <cui-cell :cellStyle="small">
                        <div slot="title" class="flex-row column-center-top">
                            <cui-icon size="32" name="ion-ios-location-outline"></cui-icon>
                    ...
                    <cui-cell :cellStyle="largerwhite" v-for='(value, index) in datas' :key="index">
                        ...
                        <div slot="title" class="flex-row center">
                            ...
                            <div class="circle-box center ml30" :style="{'background-color': value.color}">
                                <cui-image v-if="value.img" :src="value.img" width="90px" height="90px"></cui-image>
